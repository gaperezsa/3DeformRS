...
parser.add_argument("--model", default='pointnet2',choices=model_choices, help="which dataset")
...
if (args.model == "pointnet2"):
    ...
    try:
        ...
        print(f'pretrained model found, previously trained for {previous_epochs} epochs,starting test')
    except:
        print('no pretrained model found or wrong matching, ending program')
        quit()
